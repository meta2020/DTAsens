##
## OPTIMIZATION FUNCTION 1; ESTIMATE C1 C2 
##
##
## CREATE: 2020-12-22: CHANGE NAME AND REVISE DETAILS
## REVISE: 2021-01-04: CHECK
##
## INPUT:  START POINT 7 PARS: c(u1, u2, t1, t2, r, b, c1)
## OUTPUT: "u1", "u2", "t11", "t22", "t12", "r", "auc", 
##         "b", "a", "c11", "c22", "c1/c2", ("p.hat"), "conv"
